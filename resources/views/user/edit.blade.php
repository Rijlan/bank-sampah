...
<form action="{{ route('user.update', $user->id) }}" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <select name="role" id="role" class="form-control" required>
            ...
            <option value="1" {{ $user->role == 1 ? 'selected' : '' }}>Pengurus 1</option>
            <option value="2" {{ $user->role == 2 ? 'selected' : '' }}>Pengurus 2</option>
            <option value="3" {{ $user->role == 3 ? 'selected' : '' }}>Nasabah</option>
            <option value="4" {{ $user->role == 4 ? 'selected' : '' }}>Bendahara</option>
